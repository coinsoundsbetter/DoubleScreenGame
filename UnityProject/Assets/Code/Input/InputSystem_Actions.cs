...
public partial class @InputSystem_Actions: IInputActionCollection2, IDisposable
{
    ...
    ""controlSchemes"": [
        ...
        m_PlayerA_Interact = m_PlayerA.FindAction("Interact", throwIfNotFound: true);
        ...
        m_PlayerA_Previous = m_PlayerA.FindAction("Previous", throwIfNotFound: true);
        m_PlayerA_Next = m_PlayerA.FindAction("Next", throwIfNotFound: true);
    ...
    ~@InputSystem_Actions()
    {
        UnityEngine.Debug.Assert(!m_PlayerA.enabled, "This will cause a leak and performance issues, InputSystem_Actions.PlayerA.Disable() has not been called.");
    ...
    private readonly InputAction m_PlayerA_Interact;
    private readonly InputAction m_PlayerA_Crouch;
    private readonly InputAction m_PlayerA_Jump;
    private readonly InputAction m_PlayerA_Previous;
    private readonly InputAction m_PlayerA_Next;
    ...
    public struct PlayerAActions
    {
        ...
        /// </summary>
        public PlayerAActions(@InputSystem_Actions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        ...
        /// <summary>
        /// Provides access to the underlying input action "PlayerA/Interact".
        /// </summary>
        public InputAction @Interact => m_Wrapper.m_PlayerA_Interact;
        /// <summary>
        /// Provides access to the underlying input action "PlayerA/Crouch".
        /// </summary>
        ...
        /// <summary>
        /// Provides access to the underlying input action "PlayerA/Previous".
        /// </summary>
        public InputAction @Previous => m_Wrapper.m_PlayerA_Previous;
        /// <summary>
        /// Provides access to the underlying input action "PlayerA/Next".
        /// </summary>
        public InputAction @Next => m_Wrapper.m_PlayerA_Next;
        /// <summary>
